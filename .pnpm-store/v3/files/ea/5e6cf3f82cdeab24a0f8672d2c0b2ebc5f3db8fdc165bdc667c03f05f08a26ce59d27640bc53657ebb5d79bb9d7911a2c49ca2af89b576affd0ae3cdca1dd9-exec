import l from"repl";import{transform as c}from"@esbuild-kit/core-utils";import{v as i}from"./package-4f7aaad4.js";console.log(`Welcome to tsx v${i} (Node.js ${process.version}).
